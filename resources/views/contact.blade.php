<x-layout>
    ...
    <x-slot name='content'>
        ...
        <div class="row text-white mb-5">
            ...
            <div class="col-sm-9 mb-5">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="inputTextarea">Your messagee</label>
            ...
            <div class="col-sm-3 text-center">
                <ul class="list-unstyled">
                    ...
                    <li>
                        <a href="https://github.com/Gkdave?tab=repositories"><i class="fa-brands fa-github fa-2x i-color"></i></a>
                        <p>github</p>
                    </li>
                    <li>
      ...
      <div class="text-center">
        ...
        <a href="#" target="_blank"> <i class="fab fa-facebook fi-color mx-3"></i></a>
